...
describe BumpZone do
  ...
  context '#soa_oneline?' do
    ...
    it 'One line SOA (end commented)' do
      expect(BumpZone.soa_oneline?(open_fixture('oneline-soa-end-commented'))).to eq true
    end
    it 'One line found (extra char)' do
      expect(BumpZone.soa_oneline?(open_fixture('oneline-soa-extra-char'))).to eq true
    end
    it 'One line found (hypens)' do
      expect(BumpZone.soa_oneline?(open_fixture('oneline-soa-hypens'))).to eq true
    end
    ...
    it 'Multiline SOA (end commented)' do
      expect(BumpZone.soa_oneline?(open_fixture('multiline-soa-end-commented'))).to eq false
    end
    it 'Multiline SOA (extra char)' do
      expect(BumpZone.soa_oneline?(open_fixture('multiline-soa-extra-char'))).to eq false
    end
    it 'Multiline SOA (hypens)' do
      expect(BumpZone.soa_oneline?(open_fixture('multiline-soa-hypens'))).to eq false
    end
